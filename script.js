...
function get_survivor_perks() {
    return [
        ...
        { src: './images/secondWind.png', name: 'セカンドウィンド' },
        ...
        { src: './images/camaraderie.png', name: '仲間意識' },
        { src: './images/sprintBurst.png', name: '全力疾走' },

        { src: './images/empathy.png', name: '共感' },
        { src: './images/innerStrength.png', name: '内なる力' },
        ...
        { src: './images/fixated.png', name: '執着心' },
